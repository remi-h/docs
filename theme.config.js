export default {
  ...
  logo: (
    <>
      <span className="mr-2 font-extrabold hidden md:inline" style="display: block">🇸🇪</span>
      <span className="text-gray-600 font-normal hidden md:inline" style="display: block">
        REMI in SWEDEN
      </span>
    </>
  ),
